...
6. We can now convert the decompiled codes back to `.apk` file. Go back to `Easy APK tool`, change the compile name, then click on Compile to compile it back to apk file. The generated `.apk` file will be created under `/2-Recompiled APKs/`.    
...
5. We can now convert the decompiled codes back to `.apk` file. Go back to `Easy APK tool`, change the compile name, then click on Compile to compile it back to apk file. The generated `.apk` file will be created under `/2-Recompiled APKs/`.  
![image](https://user-images.githubusercontent.com/87559347/197329747-74eacbf7-affe-4353-b419-df8397264f2e.png)
...
3. We can now convert the decompiled codes back to `.apk` file. Go back to `Easy APK tool`, change the compile name, then click on Compile to compile it back to apk file. The generated `.apk` file will be created under `/2-Recompiled APKs/`.  
![image](https://user-images.githubusercontent.com/87559347/197329747-74eacbf7-affe-4353-b419-df8397264f2e.png)
...
2. We can now convert the decompiled codes back to `.apk` file. Go back to `Easy APK tool`, change the compile name, then click on Compile to compile it back to apk file. The generated `.apk` file will be created under `/2-Recompiled APKs/`.  
![image](https://user-images.githubusercontent.com/87559347/197329747-74eacbf7-affe-4353-b419-df8397264f2e.png)
